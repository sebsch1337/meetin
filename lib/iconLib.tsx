...
export const pinYellowIcon = L.icon({
...
export const pinRedIcon = L.icon({
...
export const pinGreyIcon = L.icon({
...
export const pinGreenIcon = L.icon({
...
export const pinPinkIcon = L.icon({
